...
<head>
    ...
    <link rel="icon" href="/Algorism_Quiz/Lotto_Quiz/lotto_ico.ico" >
</head>
'''
...
WINNING_NUMBERS = lotto_algo.draw_winning_numbers()
NUM_TRIES = 100
...
for i in range(NUM_TRIES):
    attempt = sorted(lotto_algo.generate_numbers(6))
    prize = lotto_algo.check(attempt, WINNING_NUMBERS)
